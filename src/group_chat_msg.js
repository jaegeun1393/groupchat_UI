...
class GroupChatMsg extends Component {
    constructor(props) {
        ...
        this.close_calling = this.close_calling.bind(this);
    ...
    closepanel(bol) {
        ...
        if (bol == "on") {
            ...
            var main2 = document.getElementById("calling");
            main2.className = "fixed bottom-[15px] left-[15px] font-sans text-gray-700 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-80 rounded-3xl w-[300px] justify-center content-center";
        }
    }

    showVideoCall() {
        var main3 = document.getElementById("videoCalling");
        main3.className = "fixed overflow-y-auto w-[350px] h-[800px] right-[30px] top-[100px] felx flex-col";
    }

    close_calling() {
        var main2 = document.getElementById("calling");
        main2.className = "hidden fixed bottom-[15px] left-[15px] font-sans text-gray-700 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-80 rounded-3xl w-[300px] justify-center content-center";
    
        var main3 = document.getElementById("videoCalling");
        main3.className = "hidden fixed overflow-y-auto w-[350px] h-[800px] right-[30px] top-[100px] felx flex-col";
    }
    ...
    render() {
        return (
            <>
                ...
                <div id="calling" className="hidden fixed bottom-[15px] left-[15px] font-sans text-gray-700 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-80 rounded-3xl w-[300px] justify-center content-center">
                    <div className="opacity-100 box-border flex flex-col h-full p-6">
                        ...
                        <div className="flex flex-row mt-4 font-sans text-white">
                            ...
                            <button onClick={() => this.close_calling()} className="ml-[50px] rounded-full bg-rose-700 w-[40px] h-[40px]">
                ...
                {/* video calling */}
                <div className="hidden fixed overflow-y-auto w-[350px] h-[800px] right-[30px] top-[100px] felx flex-col" id="videoCalling">
                    <div className="w-[300px] h-[200px] bg-gray-900 rounded-2xl text-white m-2">
                        video
                    </div>
                    <div className="w-[300px] h-[200px] bg-gray-900 rounded-2xl text-white m-2">
                        video
